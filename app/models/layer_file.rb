# SHP file containing polygons from the cartodb layer table
class LayerFile
  ...
  # @param [Integer] layer_status the enum of layer polys we want (e.g. user edits, original etc.)
  # @param [String] email optional user email address to filter by
  ...
  # Query cartodb for the layer data, and build the shp file
  #
  # @return [String] the location of the shp file
  def generate
    require 'net/http'
    require 'uri'
